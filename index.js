...
const messagesNotification1 = document.querySelector('#message-notification1');
...
menuItems.forEach(item => {
    item.addEventListener('click', () => {
        ...
        if (item.id != 'notifications' && item.id != 'notifications1') {
            ...
            document.querySelector('#notifications1 .notification-count1').style.display = 'none';
        }
    });
})
//MESSAGES 
//hightlight messages card when you click on the message button
const searchMessage = () => {
...
messagesNotification1.addEventListener('click', () => {
    messagesNotification1.querySelector('.notification-count1').style.display = 'none';
})
...
// THEME DISPLAY COSTUMIZATION

//opens themesModal 
const openThemeModal = () => {
    themeModal.style.display = 'grid';
}
const openThemeModal1 = () => {
    themeModal.style.display = 'grid';
}
...
theme1.addEventListener('click', openThemeModal1);
...
//remove active class from theme picker
...
//change primary colors for themes
colorPalette.forEach(color => {
